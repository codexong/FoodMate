...
import com.example.foodmate.databinding.ActivityBoardDetailBinding
...
class BoardDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        plusButton.setOnClickListener {
            MainActivityUtil.showPopupMenu(this@BoardDetail, plusButton)
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return MainActivityUtil.onOptionsItemSelected(this@BoardDetail, item)
